...
@section('title', __('general.Update Member') )
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('general.Update Member')}}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('member.update',$member->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
