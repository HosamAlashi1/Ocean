...
@section('title', __('general.Add process') )
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('general.Add process')}}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('process.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
